    ...
    "commands": [
        {
            ...
            "events": {
                "onAnswer": [
                    {"command":"bridgeCall","name":"bridge"},
                    {
                        "command": "dial",
                        "name": "connect_stream",
                        "from": {"type":"PHONE","phone":{"number":SINCH_NUMBER}},
                        "to": {
                            ...
                            "stream": {
                                "endpoint": WS_URL,
                                "streamOptions": {"version":1,"codec":"PCM","sampleRate":16000},
                                "callHeaders": [{"key":"X-Timeout-Seconds","value":"10"}]
                            }
                        },
                        "events": {
                            "onAnswer": [{"command":"bridgeCall","name":"bridge"}]
                        }
                    }
                ],
                "onHangup": [
                    {"command":"hangup","name":"connect_stream"},
                    {"command":"hangup","name":"connect_pstn"}
                ]
            }
        }
    ]
