...
def webhook():
    ...
    if event == "call.incoming":
        ...
        # Respond with SVAML to bridge the inbound call to the WebSocket stream.
        # On a call.incoming response the commands run directly; top-level "callName"
        # names the inbound leg and "events.onHangup" handles cleanup when it ends.
        ...
        svaml_response = {
            ...
            "commands": [
                ...
                # Add the inbound leg to a named audio bridge
                ...
                # Dial the WebSocket stream endpoint — your AI agent
                {
                    ...
                    "events": {
                        ...
                        # Stream disconnects -> hang up the inbound call
                        "onHangup": [{"command": "hangup", "callName": "inbound"}]
                    }
                }
            ],
            "events": {
                # Inbound caller hangs up -> disconnect the stream leg
